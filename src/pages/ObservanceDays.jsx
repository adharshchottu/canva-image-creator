...
import background from '../assets/observance-bg.jpeg';
                ...
                <div className='relative p-8 flex flex-col w-1/2'>
                    ...
                    <div className='flex flex-col space-y-5'>
                        <div className='flex flex-row'>
                            ...
                            <div>
                                <label htmlFor="BG Width" className="block text-sm font-medium leading-6 text-gray-900">
                                    BG Width
                                </label>
                                <div className="relative mt-2 rounded-md shadow-sm">
                                    <input
                            ...
                            <div>
                                <label htmlFor="BG Height" className="block text-sm font-medium leading-6 text-gray-900">
                                    BG Height
                                </label>
                                <div className="relative mt-2 rounded-md shadow-sm">
                                    <input
